...
const EPL_QUIZ_QUESTIONS = [
  {
    id: 1,
    question: "Which club has won the most Premier League titles?",
    options: ["Liverpool", "Chelsea", "Manchester United", "Arsenal"],
    correctAnswer: "Manchester United",
    explanation: "Manchester United has won 13 Premier League titles since its formation in 1992."
  },
  {
    id: 2,
    question: "Who is the Premier League's all-time top scorer?",
    options: ["Wayne Rooney", "Sergio Agüero", "Harry Kane", "Alan Shearer"],
    correctAnswer: "Alan Shearer",
    explanation: "Alan Shearer holds the record with 260 Premier League goals."
  },
  {
    id: 3,
    ...
    explanation: "Ryan Giggs holds the record with 162 Premier League assists."
  },
  {
    id: 4,
    question: "Which club completed the 'Invincibles' season without losing a single Premier League game?",
    options: ["Chelsea", "Liverpool", "Manchester City", "Arsenal"],
    correctAnswer: "Arsenal",
    explanation: "Arsenal went unbeaten throughout the entire 2003-04 season, earning the 'Invincibles' title."
  },
  {
    id: 5,
    question: "Who scored the fastest hat-trick in Premier League history?",
    options: ["Sadio Mané", "Sergio Agüero", "Robbie Fowler", "Jamie Vardy"],
    correctAnswer: "Sadio Mané",
    explanation: "Sadio Mané scored three goals in 2 minutes and 56 seconds for Southampton against Aston Villa in 2015."
  }
];

export default function EPLQuizPage() {
  ...
  const handleOptionSelect = (option: string) => {
    ...
    if (option === EPL_QUIZ_QUESTIONS[currentQuestionIndex].correctAnswer) {
  ...
  const handleNextQuestion = () => {
    if (currentQuestionIndex < EPL_QUIZ_QUESTIONS.length - 1) {
  ...
  const currentQuestion = EPL_QUIZ_QUESTIONS[currentQuestionIndex];
  ...
  return (
    <div className="pt-16 min-h-screen bg-gradient-to-b from-indigo-900 to-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {showStartModal ? (
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-6 flex items-center justify-center">
                <span className="text-4xl mr-3">⚽</span> EPL Trivia Challenge
              </h1>
              <p className="text-gray-300">Test your knowledge of Premier League teams, players, history and more!</p>
            </div>
          ...
          >
            <div className="text-center">
              ...
              <div className="mb-8">
                ...
                <p className="text-2xl font-bold text-indigo-400">Your Score: {score}</p>
              </div>
              ...
              <div className="bg-gray-700 rounded-lg p-6 mb-8">
                ...
                <div className="flex justify-around">
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-white">{EPL_QUIZ_QUESTIONS.length}</p>
                  </div>
                  <div className="text-center">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.4 }}
          >
            <div className="p-6 bg-gradient-to-r from-indigo-800 to-indigo-900">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-indigo-200">EPL Quiz — {difficulty}</p>
                  <h2 className="text-2xl font-bold text-white">Question {currentQuestionIndex + 1}/{EPL_QUIZ_QUESTIONS.length}</h2>
                </div>
            ...
            <div className="p-6">
              ...
              {isAnswered && (
                <div className="text-center">
                  ...
                  >
                    {currentQuestionIndex < EPL_QUIZ_QUESTIONS.length - 1 ? "Next Question" : "Finish Quiz"}
                  </button>
                </div>
              )}
            </div>
