        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/quiz/nfl" className="text-gray-400 hover:text-white transition duration-150">
                  NFL Quizzes
                </Link>
              </li>
              <li>
                <Link href="/quiz/nba" className="text-gray-400 hover:text-white transition duration-150">
                  NBA Quizzes
                </Link>
              </li>
              <li>
                <Link href="/quiz/mlb" className="text-gray-400 hover:text-white transition duration-150">
                  MLB Quizzes
                </Link>
              </li>
              <li>
                <Link href="/quiz/epl" className="text-gray-400 hover:text-white transition duration-150">
                  EPL Quizzes
                </Link>
              </li>
            </ul>
