      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Contact Us <span className="text-blue-400">📧</span>
          </h1>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div variants={itemVariants}>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
              ...
              {formStatus.type && (
                <motion.div
                  ...
                  className={`rounded-lg p-4 ${
                    formStatus.type === 'success' ? 'bg-green-800 text-green-100' : 'bg-red-800 text-red-100'
                  }`}
                >
                  {formStatus.message}
                </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex justify-end">
                <button
                  ...
                  className={`bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-3 px-8 rounded-full transition duration-300 flex items-center ${
